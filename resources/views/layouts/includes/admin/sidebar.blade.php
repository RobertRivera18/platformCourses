        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                ...
                open:{{$link['active'] ? 'true' : 'false'}},
                    ...
                    <button 
                        class="flex items-center w-full p-2 text-gray-900 rounded  group {{$link['active']?'bg-gray-100':''}}"
                        x-on:click="open=!open"
                        >
                        <span class="inline-flex w-6 h-6 justify-center items-center text-gray-500">
                            <i class="{{$link['icon']}}"></i>
                        </span>
                    ...
                    <ul x-show="open" x-cloak>
                        ...
                        <li class="pl-4">
                            <a href=""
                                class="flex items-center p-2 text-gray-900 rounded group {{$item['active']?'bg-gray-100':''}}">
                                <span class="inline-flex w-6 h-6 justify-center items-center text-gray-500">
                                    <i class="{{$item['icon']}}"></i>
                                </span>
                                <span class="ms-3  text-left flex-1">
                ...
                <a href="{{$link['route']}}"
                    class="flex items-center p-2 text-gray-900 rounded group {{$link['active']?'bg-gray-100':''}}">
                    <span class="inline-flex w-6 h-6 justify-center items-center text-gray-500">
                        <i class="{{$link['icon']}}"></i>
                    </span>
                    <span class="ms-3">
